...
public class KakaoRestApiHelperTest {
	...
	public void test() {
		// access token 지정
		apiHelper.setAccessToken("0f422dffd4731502769808a54a223404");
		apiHelper.signup();
		apiHelper.jsonGetValue(apiHelper.getUserAccessTokenInfo(), "id");
		System.out.println("asdf: "+apiHelper.getUserAccessTokenInfo());
		// 푸시 알림이나 유저 아이디 리스트가 필요할 때 설정 합니다.
		// (디벨로퍼스 내에 앱설정 메뉴를 가시면 있습니다)
//		apiHelper.setAdminKey("a15589a55701f13209bd940fdd8cd165");
